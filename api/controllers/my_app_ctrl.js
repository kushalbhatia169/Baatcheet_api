...
// // const checkAuthenicator = async(req) => {
...
//         })
//       }
//       user.checkExpireJWT(body.token)
//         .then(isTokenExpired => {
//           if(isTokenExpired) {
//             return res.status(404).json({
...
// const checkExpireJWT = async (token) => {
...
//     await user.checkExpireJWT(body.token)
//       .then(isTokenExpired => {
//         if(isTokenExpired) {
//           return res.status(404).json({
//             message: 'session expired',
